...
So that I can store my favourites
   ...
   Scenario Outline: Creating a new User
	...
	And then I input "<firstName>" "<lastName>" "<password>" "<dob>" "<address>" "<city>" "<state>" "<zipCode>" "<phone>"
	Then I will create my profile
   
Examples:
	|	title	|	firstName	|	lastName	|	dob	|	address	|	city	|	state	|	zipCode	|	phoneNumber	|	email	|	password	|
	...
	|	Mrs.	|	Ghuttla	|	Dirtfist	|	9 October 1997	|	Sinlams Pathway	|	Boulderbourne	|	Missouri	|	01902	|	07700 900523	|	Ghuttla.Dirtfist@gmail.com	|	megasky19	|
	|	Mr.	|	Zhaaktet	|	Alabasterchest	|	10 February 2001	|	Nokocord Path	|	Oceankeep	|	Virginia	|	11374	|	07700 900365	|	Zhaaktet.Alabasterchest@gmail.com	|	lumpyjewel23	|